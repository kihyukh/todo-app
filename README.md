...
- 127 automated frontend tests cover date independence, task visibility, merge convergence, deletion preservation, concurrent browser saves, rich Markdown/math round trips, nested checkbox updates, directional math navigation, list/quote/table cursor behavior, link clicks, Vim commands and modes inside equation source, typing batches, immediate task switches, and shutdown flushes.
